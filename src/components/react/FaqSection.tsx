...
const FAQS: FaqItem[] = [
  {
    ...
    answer: (
      <div className="space-y-3 text-xs text-neutral-300 leading-relaxed">
        ...
        <div className="p-3 rounded-xl bg-neutral-950 border border-neutral-800 font-mono text-neutral-200 text-xs overflow-x-auto">
        ...
        <div className="p-2.5 rounded-lg bg-neutral-900 border border-neutral-800 font-mono text-neutral-200">
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-xs text-neutral-300 leading-relaxed">
        ...
        <ul className="list-disc list-inside space-y-1.5 text-neutral-300 ml-1">
          <li><b>Uncheckpointed Activations:</b> Memory scales linearly with <code className="text-neutral-100 font-mono bg-neutral-900 px-1 py-0.5 rounded border border-neutral-800">layers × hidden_dim × sequence_length × batch_size</code>.</li>
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-3 text-xs text-neutral-300 leading-relaxed">
        ...
        <div className="overflow-x-auto rounded-xl border border-neutral-800 bg-neutral-950 p-2">
          <table className="w-full text-left font-mono text-[11px]">
            ...
            <tbody className="divide-y divide-neutral-800">
              <tr>
                <td className="p-2 text-neutral-200 font-bold">Full Fine-Tune (FP16)</td>
                <td className="p-2">140 GB</td>
                <td className="p-2">980 GB (AdamW + Grads)</td>
                <td className="p-2 text-neutral-100 font-bold">&gt; 1,100 GB (16x A100)</td>
              </tr>
              <tr>
                <td className="p-2 text-neutral-200 font-bold">Standard LoRA (16-bit)</td>
                <td className="p-2">140 GB</td>
                <td className="p-2">~12 GB (r=16 adapters)</td>
                <td className="p-2 text-neutral-100 font-bold">~165 GB (2x A100 80GB)</td>
              </tr>
              <tr>
                <td className="p-2 text-neutral-200 font-bold">QLoRA (4-bit NF4)</td>
                <td className="p-2">38.5 GB</td>
                <td className="p-2">~3.5 GB (r=16 adapters)</td>
                <td className="p-2 text-neutral-100 font-bold">~48 GB (1x A100 or 2x 4090)</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export const FaqSection: React.FC = () => {
  ...
  return (
    <div className="rounded-2xl border border-neutral-800 bg-neutral-900/40 p-6 sm:p-10 space-y-8">
      {/* Header */}
      <div className="max-w-3xl">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-neutral-800 border border-neutral-700/60 text-neutral-300 text-xs font-mono mb-2">
          ...
          return (
            <div
              ...
              className={`rounded-2xl border transition-all duration-200 overflow-hidden ${
                isOpen
                  ? 'border-neutral-700 bg-neutral-950 shadow-xs'
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-[10px] font-mono uppercase tracking-wider text-neutral-400 font-medium block mb-0.5">
                      {faq.category}
                    </span>
                    <h3 className="text-sm font-semibold text-neutral-100">{faq.question}</h3>
                  </div>
                </div>

                <div className={`p-1 rounded-lg text-neutral-400 transition-transform duration-200 shrink-0 ${isOpen ? 'rotate-180 text-neutral-200' : ''}`}>
                  <ChevronDown className="w-4 h-4" />
                </div>
              </button>

              {isOpen && (
                <div className="px-5 pb-5 pt-2 border-t border-neutral-800 animate-fadeIn">
                  {faq.answer}
                </div>
              )}
            </div>
